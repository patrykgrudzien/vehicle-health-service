	...
	public final String createRedirectionUrl(final AppFLow appFLow, final Tuple2<String, String>... additionalParameters) {
		return Match(appFLow).of(
				Case($(is(ACCOUNT_ALREADY_ENABLED)), () -> {
					...
					log.info(ACCOUNT_ALREADY_ENABLED.getSuccessfulRedirectionLogInfoMessage(), userAlreadyEnabledURL);
				...
				Case($(is(CONFIRM_REGISTRATION)), () -> {
					...
					log.info(CONFIRM_REGISTRATION.getSuccessfulRedirectionLogInfoMessage(), registrationConfirmedURL);
				...
				Case($(is(VERIFICATION_TOKEN_NOT_FOUND)), () -> {
					...
					log.info(VERIFICATION_TOKEN_NOT_FOUND.getSuccessfulRedirectionLogInfoMessage(), confirmedTokenNotFoundURL);
				...
				Case($(is(VERIFICATION_TOKEN_EXPIRED)), () -> {
					...
					log.info(VERIFICATION_TOKEN_EXPIRED.getSuccessfulRedirectionLogInfoMessage(), confirmedTokenExpiredURL);
                ...
                Case($(is(SYSTEM_COULD_NOT_ENABLE_USER_ACCOUNT)), () -> {
                    ...
                    log.info(SYSTEM_COULD_NOT_ENABLE_USER_ACCOUNT.getSuccessfulRedirectionLogInfoMessage(), systemCouldNotEnableUserAccountURL);
